<template>
  ...
  <button
    ...
    data-bs-target="#confirmationModalChatId"
  >
  </button>
  ...
  <div
    class="modal fade"
    id="confirmationModalChatId"
    tabindex="-1"
    aria-labelledby="confirmationModalChatLabel"
    aria-hidden="true"
  >
