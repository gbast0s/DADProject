  ...
  <div class="background_image">
    <section class="hero">
      <div class="container">
        <div class="hero-inner">
          <div class="hero-copy">
            <h1>Create your Vcard now</h1>
            <p class="hero-paragraph text-sm">
              Paying with Vcard is easy, pratical and safe.
            </p>
            <div class="hero-cta">
              <router-link
          ...
          <div>
            <img src="/img/vcardexample.png" style="position: relative" />
          </div>
        </div>
      </div>
    </section>
    <section class="features section">
          ...
          <div class="features-wrap">
            <div class="feature text-center is-revealing">
              <div class="feature-inner">
                ...
                <h4 class="feature-title mt-24">Create your unique wallet</h4>
                <p class="text-sm mb-0">
                  You can create your Vcard for all your needs, you can use it
                  to shop online to receive/send money and to withdraw money to
                  your bank.
                </p>
              </div>
            </div>
            <div class="feature text-center is-revealing">
              <div class="feature-inner">
                ...
                <h4 class="feature-title mt-24">
                  Save money with our wallet management system
                </h4>
                <p class="text-sm mb-0">
                  With our Vcard Management system you can see all of your
                  transactions and with our message pop-up system you will
                  always be aware of every trasaction received all in real time
            ...
            <div class="feature text-center is-revealing">
              <div class="feature-inner">
                ...
                <h4 class="feature-title mt-24">Send money to your friends</h4>
                <p class="text-sm mb-0">
                  If your friend has a Vcard too, you can send him money easily
                  and instantly.
                </p>
              </div>
            </div>
      ...
      <div class="footer">
        ...
        Developed by:
          <strong
            >Fábio Faria, Gonçalo Bastos, Lourenço Lourenço, Vasco
            Perdigão</strong
          >
        </p>
      </div>
